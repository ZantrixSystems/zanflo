...
export const api = {
  ...
  listAdminRoles: () => request('GET', '/api/admin/roles'),
  createAdminRole: (body) => request('POST', '/api/admin/roles', body),
  updateAdminRole: (id, body) => request('PUT', `/api/admin/roles/${id}`, body),
  deleteAdminRole: (id) => request('DELETE', `/api/admin/roles/${id}`),

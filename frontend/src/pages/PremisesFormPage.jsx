  ...
  return (
    <Layout
      breadcrumbs={[
        ...
        { label: isNew ? 'New premises' : (premises?.premises_name || 'Premises') },
      ]}
    ...
    >
      ...
      {loading ? (
          ...
          <section className="form-section">
            ...
            <p className="page-subtitle">
              {isNew
                ...
                : 'Update the details below. Changing the address will reset your verification submission.'}
            </p>
          </section>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="platform-hero-actions">
              <button type="submit" className="btn btn-primary" disabled={saving}>
                {saving ? 'Saving...' : isNew ? 'Create premises' : 'Save changes'}
              </button>
              {!isNew && (
        ...
        <>
          <section className="form-section">
            <div className="form-section-title">Premises record</div>
            <h1 className="page-title">{premises?.premises_name || 'Premises'}</h1>
            <div className="premises-detail-grid">
              <div className="premises-detail-row">
                <span className="premises-detail-label">Address</span>
                <span className="premises-detail-value">
              ...
              {premises?.premises_description && (
                <div className="premises-detail-row">
                  <span className="premises-detail-label">Description</span>
                  <span className="premises-detail-value">{premises.premises_description}</span>
                </div>
              )}
            </div>
          ...
          <section className="form-section">
            ...
            {verificationState === 'more_information_required' && verificationEvents.length > 0 && (
              <div className="soft-panel" style={{ marginTop: 16 }}>
                ...
                <p className="platform-body-copy">{verificationEvents[0].notes || 'The council has requested more information. Edit your premises details and resubmit.'}</p>
              </div>
            )}
